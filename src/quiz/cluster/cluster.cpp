...
/**
 * \brief Helper function to \b euclideanCluster
 * \param[in, out] cluster a point cluster
 * \param[in, out] p_points a vector containing processed points
 * \param[in] id point id - here point index
 * \param[in] tree a kdTree 
